    ...
    const unsubscribe = onSnapshot(
      ...
      (querySnapshot) => {
        ...
        if (newIds.size > 0 && students.length > 0) {
          ...
          window.toastify(
            `🎉 ${newIds.size} new student${newIds.size > 1 ? "s" : ""
            } registered!`,
            "success"
          );
              ...
              <div className="container d-flex justify-content-between align-items-center px-0">
                ...
                <ul className="navbar-nav flex-row align-items-center mb-0">
                  <li className="nav-item me-3 mb-2 mb-md-0">
                    <button className="mainButton btn-responsive-size position-relative">
                      All Students
                  ...
                  <li className="nav-item mb-2 mb-md-0 me-3">
                    <button
                      type="button"
                      className="mainButton btn-responsive-size position-relative"
                    >
                      Today Registered
                      <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                  ...
                  <li className="nav-item mb-2 mb-md-0">
                    <button
                      type="button"
                      className="mainButton btn-responsive-size"
                      onClick={logout}
                    >
                      Logout
                    </button>
